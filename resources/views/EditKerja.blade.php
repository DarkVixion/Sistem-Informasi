                         ...
                         <div class="card card-info">
                             ...
                             <div class="card-body">
                                 <div class="form-group row">
                                     ...
                                     <label for="inputPassword3" class="col-sm-2 col-form-label">Nomor Telepon</label>
                                     <div class="col-sm-10">
                                         <input type="number" class="form-control" name='notelppic' id="notelppic" placeholder="No Telepon PIC" @if(count($users) !=0 && $tks->assignuserakun != null)value="{{ $users[($tks->assignuserakun)-1]->notelpakunuser }}"@endif readonly>
                                     </div>
                                     <br><br>
                                     <label for="inputPassword3 " class="col-sm-2 col-form-label ">Email</label>
                                     <div class="col-sm-10 ">
                                         <input type="text" class="form-control" name="emailpic" id="emailpic" placeholder="Email PIC" @if(count($users) !=0 && $tks->assignuserakun != null)value="{{ $users[($tks->assignuserakun)-1]->emailakunuser }}" @endif readonly>
                                     </div>
                                 </div>
                             </div>
                             <!-- /.card-body -->
