                        ...
                        <table class="table table-hover text-nowrap">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a href="{{route('view_user', $itemuser->id)}}"><button class="btn btn-info"><i class="fa fa-eye"></i></button></a>
                                        {{-- YANG INI NADD DELETENYA HEHEHE --}}
                                        <form action="{{route('hapus_user', $itemuser->id)}}" method="POST" style="display:inline ">
                                            {{ method_field('DELETE') }}
                                            {{ csrf_field() }}
                                            <button type="submit" class="btn btn-danger"><i class="fa fa-trash"></i></button>
                                        </form>
